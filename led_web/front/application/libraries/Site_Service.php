...
class Site_Service_Core extends DefaultService_Core 
{
    ...
    public function echo_zxdt($lan = 'cn') {
    	/**
    	 竞搏动态1
    	 */
    	$query_struct = array(
    	...
    	$data['jb_news'] = $news_gg;
    	if ($lan == 'cn') {
    		$return = View::factory('zxdt_', $data)->render();
    	}
    	else {
    		$return = View::factory('zxdt_'.$lan.'_', $data)->render();
    	}
    	return $return;
    }
}