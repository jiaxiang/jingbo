...
?>
	...
	<div id="innerWrapper">
		...
		<div id="wrapper_right">
			<h3><span>Location：<a href="<?php echo url::base();?>en/index">HOME</a> >> Products >> <a href="<?php echo url::base();?>en/products/products_list/<?php echo $news_classify;?>"><?php echo $news_classify_name;?></a></span><font class="font_666">LED Lighting</font></h3>
			<div class="content">
				...
				<div class="products_show">
					...
					<div class="products_show_con">
						<p>Product Name：<?php echo $news_infor[0]['title_en']?></p>
						<p>Product Model：<?php echo $news_infor[0]['type_en']?></p>
						<p>Product Category：<?php echo $news_infor[0]['issue_en']?></p>
							<?php
		...
		<!-- JiaThis Button END -->
				...
				<div class="product_details_title">Pro files</div>
