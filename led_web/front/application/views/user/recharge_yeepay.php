...
<form id='check_out' name='check_out' method="post"  action="/payment/yeepay_to" target="_blank">        
	...
	<div class="tips_b">
      ...
      <div class="fl cz_bank">
        ...
        foreach ($pay_banks as $key => $row)
		{
			...
			echo '<label for="payment_'.$key.'"><img src="'.url::base().'media/images/banks_yee/'.$key.'.gif" title="'.$row.'" alt="'.$row.'" /></label>';
			echo '</td>';
