...
<div class="width">
  ...
  <div class="member_right fl">
    <div id="member_tit" class="fl">
      <ul>
        <li><a href="<?php echo url::base();?>user/capital_changes">资金变动明细</a></li>
        <li class="hover"><a href="<?php echo url::base();?>user/virtual_capital_changes">竞波币明细</a></li>
      </ul>
    </div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl" style="border-left: solid 1px #c5ddf5; border-right: solid 1px #c5ddf5;">
      ...
      <tr>
        ...
        <td width="185" height="25" align="left" valign="middle" bgcolor="#e8f2ff"></td>
        <td height="25" valign="middle" bgcolor="#e8f2ff">竞波币：<span class="font14 bold red"><?php echo $_user['user_money'];?>元</span></td>
      </tr>
      <tr>
        <td height="5" colspan="4" align="center" valign="middle" bgcolor="#e8f2ff"></td>
      </tr>
