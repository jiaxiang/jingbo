...
function reload_secoder(id,url){
    flag++;
    $('#'+id).attr("src","<?php echo url::base();?>site/secoder_regisiter/"+id+"/"+flag);
}
</script>
</head>
<body>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl" >
 ...
 <tr>
  ...
  <tr>
    ...
    <img alt="验证码" src="<?php echo url::base();?>site/secoder_regisiter/reg_secoder" id='reg_secoder' onclick="reload_secoder('reg_secoder');" /> 
    <span ></span>
