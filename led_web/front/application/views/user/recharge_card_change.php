...
<title><?php echo $site_config['site_title'];?>-会员中心-点数兑换</title>
...
<li class="hover">点数兑换</li>
<li><a href="<?php echo url::base();?>user_recharge_card/search">点卡查询</a></li>
</ul>
</div>
...
<div class="paly_pop_ok" style="top:100px; left:120px;">
	<div class="tips_b">
        <div class="tips_box">
            ...
            <div class="tips_text" style="overflow-y:auto; line-height:30px;">
         		<?php 
         		if (isset($result) && is_array($result)) echo $result['msg'];
         		?>
		    </div>
    ...
    <?php  print form::open ( 'user_recharge_card/change', array ('name' => 'formedit', 'id' => 'formedit' ) );?>
<table width="753" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td height="28" bgcolor="#faeee0" class="profile_bottom">&nbsp;</td>
		<td height="28" colspan="4" bgcolor="#faeee0" class="font14 profile_bottom orange"><strong>现有点数：<?php if (isset($result) && is_array($result)) echo $result['user_score']; else echo $user_score;?>，可兑换彩金：￥<?php if (isset($result) && is_array($result)) echo $result['user_change']; else echo $change_money?>。兑换点数需在100-1000之间</strong></td>
	</tr>
	<tr>
	...
	<tr>
		<td width="2%">&nbsp;</td>
		<td width="13%" height="30" align="right" valign="middle"><span class="black">需兑换的点数：</span></td>
		<td height="30" align="left" valign="middle">&nbsp;</td>
		<td height="30" align="left" valign="middle">
        <?php
			print form::input('change_score', '', 'class="huiyuan_text_box" datatype="*" nullmsg="请填写点数！" errormsg="点数错误！"');	 
		?>        		
		</td>
