...
?>
	...
	<div id="innerWrapper">
		...
		<div id="wrapper_right">
			<h3><span>您当前的位置：<a href="<?php echo url::base();?>">网站首页</a> >> 产品展示 >> <a href="<?php echo url::base();?>products/products_list/<?php echo $news_classify;?>"><?php echo $news_classify_name;?></a></span><font class="font_078044">led照明 </font><font class="font_666">LED Lighting</font></h3>
			<div class="content">
				<div class="products_title"><?php echo $news_infor[0]['title']?></div>
				<div class="products_show">
					<div class="products_show_img">
						<div class="products_show_img_box">
						<img src="<?php $new_pic = explode('.', $news_infor[0]['newpic']); echo $new_pic[0].'s2.'.$new_pic[1];?><?php //echo $news_infor[0]['newpic'];?>" class="img_img"  /><!-- width="450" height="308" -->
						</div>
					...
					<div class="products_show_con">
						<p>产品名称：<?php echo $news_infor[0]['title']?></p>
						<p>产品型号：<?php echo $news_infor[0]['type']?></p>
						<p>产品类别：<?php echo $news_infor[0]['issue']?></p>
							<?php
		...
		<!-- JiaThis Button END -->
				...
				<div class="product_details_title">产品详细介绍</div>
