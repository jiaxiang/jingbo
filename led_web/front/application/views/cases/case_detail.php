...
?>
	...
	<div id="innerWrapper">
		...
		<div id="wrapper_right">
			<h3><span>您当前的位置：<a href="<?php echo url::base();?>">网站首页</a> >> 工程案例 >> <a href="<?php echo url::base();?>products/products_list/<?php echo $news_classify;?>"><?php echo $news_classify_name;?></a></span><font class="font_078044">led照明 </font><font class="font_666">LED Lighting</font></h3>
			<div class="content">
				...
				<div class="products_show">
					...
					<div class="products_show_con">
						<p>案例名称：<?php echo $news_infor[0]['title']?></p>
						<p>案例型号：<?php echo $news_infor[0]['type']?></p>
						<p>案例类别：<?php echo $news_infor[0]['issue']?></p>
							<?php
		...
		<!-- JiaThis Button END -->
				...
				<div class="product_details_title">案例详细介绍</div>
