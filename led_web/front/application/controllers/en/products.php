...
class Products_Controller extends Template_Controller {
	...
	//新闻详细页
	public function product_detail($id, $play='') {
		$view = new  View('/products_en/product_detail');
	...
	public function products_list($id){
		$view = new View('/products_en/products_list');
		$view->set_global('_user', $this->_user);
        $view->set_global('_nav', NULL);
		...
		$config['base_url'] = "/en/products/products_list/".$id;
