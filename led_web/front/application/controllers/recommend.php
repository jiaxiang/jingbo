...
class Recommend_Controller extends Template_Controller{
	...
	public function index(){
		...
		//end
		$this->template = new View('news/recommend',$data);
		$this->template->set_global('_topnav','is_zhuanjia');
