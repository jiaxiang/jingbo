                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
								...
								<tr>
                                    <th width="15%">英文标题：</th>
                                    <td>
                                        <input type="text" size="50" name="title_en" class="text required" value="<?php if(isset($post['title_en']))echo $post['title_en'];?>">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>英文内容：</th>
                                    <td class="d_line">
                                        <textarea id="content_en" name="content_en" style="width:95%;" rows="20" class="text required" type="textarea" maxth="255" ><?php if(isset($post['content_en']))echo $post['content_en'];?></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
