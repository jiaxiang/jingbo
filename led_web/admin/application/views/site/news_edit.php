                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <th width="15%">英文标题：</th>
                                    <td>
                                        <input type="text" size="10" name="title_en" class="text t400  _x_ipt required" value="<?php echo $data['title_en']; ?>" />
                                    </td>
                                </tr>
								<tr>
                                ...
                                <tr>
                                    <th width="15%">英文来源：</th>
                                    <td>
                                        <input type="text" size="10" name="comefrom_en" class="text t400  _x_ipt required" value="<?php echo $data['comefrom_en']; ?>" />
                                    </td>
                                </tr>
								<tr>
                                ...
                                <tr>
                                    <th width="15%">英文关键字：</th>
                                    <td>
                                        <input type="text" size="10" name="key_en" class="text t400  _x_ipt required" value="<?php echo $data['key_en'];?>" />关键字请用“|”隔开
                                    </td>
                                </tr>
                                
                                <!--开奖信息 start-->
                                <tr>
                                    <th width="15%">型号<span class="required"> </span>：</th>
                                    <td>
                                        <input type="text" size="50" name="type" class="text t400  _x_ipt " value="<?php echo $data['type']; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th width="15%">英文型号<span class="required"> </span>：</th>
                                    <td>
                                        <input type="text" size="50" name="type_en" class="text t400  _x_ipt " value="<?php echo $data['type_en']; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th width="15%">类别<span class="required"> </span>：</th>
                                    <td>
                                        <input type="text" size="50" name="issue" class="text t400  _x_ipt " value="<?php echo $data['issue']; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th width="15%">英文类别<span class="required"> </span>：</th>
                                    <td>
                                        <input type="text" size="50" name="issue_en" class="text t400  _x_ipt " value="<?php echo $data['issue_en']; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th width="15%">附件路径<span class="required"> </span>：</th>
                                    <td>
                                        <input type="text" size="50" name="number" class="text t400  _x_ipt " value="<?php echo $data['number']; ?>" /> /media/pdf/
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>英文内容：</th>
                                    <td class="d_line">
                                        <textarea id="content_en" name="content_en" cols="75" rows="20" class="text _x_ipt t400 required" type="textarea" maxth="255" ><?php echo $data['content_en']; ?></textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <a href="javascript:void(0);" id="btn_upload_logo">点击上传</a>
                                    </td>
                                </tr>  
    ...
    $(document).ready(function(){
        $("#add_form").validate({
        	errorPlacement:function(error, element){
	            if(element.attr("name") == "content" || element.attr("name") == "content_en"){
	                //alert(error);
		...
		tinyMCE.execCommand('mceAddControl', true, 'content_en');
    });
