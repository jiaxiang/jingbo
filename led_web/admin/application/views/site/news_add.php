                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <th width="15%">英文标题：</th>
                                    <td>
                                        <input type="text" size="10" name="title_en" class="text t400  _x_ipt required" value="" />
                                    </td>
                                </tr>
								<tr>
                                ...
                                <tr>
                                    <th width="15%">英文来源：</th>
                                    <td>
                                        <input type="text" size="10" name="comefrom_en" class="text t400  _x_ipt required" value="" />
                                    </td>
                                </tr>
								<tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" size="10" name="key_en" class="text t400  _x_ipt required" value="" />关键字请用“|”隔开
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th width="15%">英文型号：</th>
                                    <td>
                                        <input type="text" size="50" name="type_en" class="text t400  _x_ipt" value="" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th width="15%">英文类别：</th>
                                    <td>
                                        <input type="text" size="50" name="issue_en" class="text t400  _x_ipt " value="" />
                                    </td>
                                </tr>
                                <tr>
                                    <th width="15%">附件路径<span class="required"> </span>：</th>
                                    <td>
                                        <input type="text" size="50" name="number" class="text t400  _x_ipt " value="" /> /media/pdf/
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>英文内容：</th>
                                    <td class="d_line">
                                        <textarea name="content_en" id="content_en" cols="75" rows="20" class="text _x_ipt t400 required" type="textarea" maxth="255" ></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th width="20%">
