                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <th>英文标题：</th>
                                    <td>
                                        <input type="text" size="50" name="title_en" class="text required  _x_ipt" value="<?php echo $data['title_en']; ?>"/>
                                </tr>
								...
								<tr>
                                    <th>英文内容<span class="required"> *</span>：</th>
                                    <td class="d_line">
                                        <textarea name="content_en" id="content_en" cols="75" rows="20" class="text _x_ipt t400 required" type="textarea" maxth="255" ><?php echo $data['content_en']; ?></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
