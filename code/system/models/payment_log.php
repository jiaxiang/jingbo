...
class Payment_log_Model extends ORM 
{
    ...
    /*public function validate(array & $array, $save = FALSE, & $errors) {
        ...
        $array = Validation::factory($array)
            ...
            ->add_rules('user_id','required','length[1,200]')
            ->add_rules('email','required','length[1,200]')
            ->add_rules('total','required','length[1,200]')
            ->add_rules('currency','required','length[1,200]')
            ->add_rules('conversion_rate','required','length[1,200]')
            ->add_rules('total_products','required','length[1,200]')
            ->add_rules('total_shipping','required','length[1,200]')
            ->add_rules('total_real','required','length[1,200]')
            ->add_rules('total_paid','required','length[1,200]')
            ...
            ->add_rules('carrier','required','length[1,200]')
