...
class Payment_google_ipn_log_Model extends ORM {
    ...
    public function validate(array & $array, $save = FALSE, & $errors) {
        ...
        $array = Validation::factory($array)
            ...
            ->add_rules('shipping_firstname','length[0,200]')
            ->add_rules('shipping_lastname','length[0,200]')
            ->add_rules('shipping_address','length[0,200]')
            ->add_rules('shipping_zip','length[0,200]')
            ->add_rules('shipping_city','length[0,200]')
            ->add_rules('shipping_state','length[0,200]')
            ->add_rules('shipping_country','length[0,200]')
            ->add_rules('shipping_phone','length[0,200]')
            ...
            ->add_rules('ip','length[0,200]')
            ->add_rules('payer_email','length[0,200]')
