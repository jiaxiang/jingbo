...
<div class="new_content">
    <div class="newgrid">
        ...
        <div class="newgrid_top">
			...
			?>
                <li>
                    <span class="add_pro"><a href="<?php echo url::base();?>user/user/add">添加新会员</a></span>
                </li>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <?php /**?><a href="<?php echo url::base();?>user/user/do_delete/<?php echo $rs['id'];?>" onclick="return confirm('停用的用户不能再登录而且不能用同样的邮箱注册，确认停用吗？');">停用</a>&nbsp;<?php **/?>
