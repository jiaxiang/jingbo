...
class Mypayment_jump_return_log_Core {
	private $data = array();
	private $orm_form = 'payment_jump_return_log';
	private $errors = NULL;
	 ...
	 * @return Array
	 */
	public function payment_jump_return_logs($where=NULL,$in=NULL,$orderby=NULL,$limit=100,$offset=0)
	{
