...
class Alipay_Notify {
	...
	function __construct(){
		$this->aliapy_config = Kohana::config('alipay_config');
	}
	...
	function verifyNotify(){
		...
		if(empty($_POST)) {//判断POST来的数组是否为空
			...
			if (preg_match("/true$/i", $responseTxt) && $mysign == $_POST["sign"]) { //&& $mysign == $_POST["sign"]
				return true;
			} else {
				return false;
			}
