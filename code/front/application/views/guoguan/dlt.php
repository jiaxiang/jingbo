...
<title><?php echo $site_config['site_title'];?>-大乐透</title>
...
<script type="text/javascript" src="/media/guoguan/js/index_new.js"></script>
	...
	<div class="guide">您现在的位置：<a title="网上买彩票" href="/">首页</a> &gt; 过关统计 &gt; <a title="大乐透" href="/dlt/">大乐透</a>
	</div>
...
<?php echo View::factory('guoguan/left')->render();?> 
		...
		<div class="guoguan_right">
			...
			<div class="box01">
				...
				<div class="t_01">
					<span class="p_left">
						<img align="absmiddle" src="/media/guoguan/img/dlt_t.jpg" id="lotimg">过关统计第
