...
<title><?php echo $site_config['site_title'];?>-足彩胜负-胜负彩过关统计</title>
...
<script type="text/javascript" src="/media/guoguan/js/index_new.js"></script>
	...
	<div class="guide">您现在的位置：<a title="网上买彩票" href="/">首页</a> &gt; 过关统计 &gt; 足彩胜负  &gt; <a title="胜负彩" href="/zcsf/sfc_14c/">胜负彩</a>
	</div>
...
<!-- 		    <div class="quk_link"><strong class="red">最新过关：</strong><a href="jq4.php" title="4场进球">4场进球</a><a href="qlc.php" title="七乐彩">七乐彩</a><a href="dlt.php" title="超级大乐透">超级大乐透</a><a href="ticai.php?lot=eexw" title="22选5">22选5</a><a href="pls.php" title="排列3">排列3</a><a href="sd.php" title="福彩3D">福彩3D</a></div>		    最新过关列表 end -->
			<div class="box01">
				...
				<div class="t_01">
					<span class="p_left"><img id="lotimg" src="/media/guoguan/img/sfc_t.jpg" align="absmiddle" />过关统计第<select name="expect" id="expect" ></select> 期
					<span id="kjdate"></span>
...
<!-- <TR> -->
<!-- <TD style="PADDING-TOP: 7px" vAlign=top width=80>开奖号码：</TD> -->
<!-- <TD vAlign=top> -->
...
<!-- <LI class=ball_red>30</LI> -->
<!-- <LI class=ball_red>33</LI> -->
<!-- <LI class=ball_blue>02</LI> -->
<!-- </UL> -->
<!-- </DIV> -->
<!-- </TD> -->
<!-- <TD style="FONT-SIZE: 12px; PADDING-TOP: 7px" vAlign=top>&nbsp;</TD> -->
...
<!-- <DIV style="PADDING-TOP: 15px" class=nr> -->
<!-- <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%"> -->
<!-- <TBODY> -->
<!-- <TR> -->
<!-- <TD> -->
...
<!-- 	<TR> -->
<!-- 	<TH scope=col>奖项</TH> -->
<!-- 	<TH scope=col>中奖注数</TH> -->
<!-- 	<TH scope=col>每注奖金</TH></TR> -->
<!-- 	<TR> -->

<!-- 	<TD>一等奖</TD> -->
<!-- 	<TD><SPAN class=cfont1>6</SPAN>&nbsp;注</TD> -->
<!-- 	<TD class=dr><SPAN class=cfont1>7,943,823</SPAN>&nbsp;元 </TD></TR> -->
<!-- 	<TR> -->
<!-- 	<TD>二等奖</TD> -->
<!-- 	<TD><SPAN class=cfont1>117</SPAN>&nbsp;注</TD> -->
<!-- 	<TD class=dr><SPAN class=cfont1>226,447</SPAN>&nbsp;元</TD></TR></TBODY> -->
<!-- 	</TABLE> -->
<!-- </TD> -->
<!-- <TD>&nbsp;</TD> -->
<!-- <TD vAlign=top> -->
<!-- <UL class=ggList> -->
<!-- <LI>全国销量：<SPAN class=cfont1>308,305,132</SPAN>元</LI> -->
<!-- <LI>奖池滚存：<SPAN class=cfont1>289,214,904</SPAN>元</LI> -->
<!-- </UL> -->
<!-- </TD> -->
<!-- </TR> -->
...
<!-- 						</ul> -->
			...
			<input id="as_ps" type="hidden" /> 
			<input id="as_tp" type="hidden" /> 
			<input id="as_tr" type="hidden" /> 

			<input id="af_ps" type="hidden" /> 
			<input id="af_tp" type="hidden" /> 
			<input id="af_tr" type="hidden" /> 
			
			
				<div class="bq01">

					<ul class="menuItem01" id="mymenu" name="mymenu">
					<!-- <li class="menu01" id="menu0"><a ><span>我的过关</span></a></li> -->
					<li class="menu02" id="menu1"><a ><span>全部成功</span></a></li>
					<!-- <li class="menu01" id="menu4"><a ><span>全部流产</span></a></li> -->
					</ul>
