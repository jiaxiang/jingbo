...
<title><?php echo $site_config['site_title'];?>-会员中心-充值记录</title>
...
<!--menu和列表_end-->
<!--面包屑导航-->
<div class="width line36">您所在的位置：<span class="blue"><a href="/">首页</a></span> &gt;&gt; <span class="blue"><a href="/user">会员中心</a></span> &gt;&gt; <span class="blue"><a href="#">资金管理</a></span> &gt;&gt; 充值记录</div>
<!--面包屑导航_end-->
<!--content1-->
<div class="width">
  ...
  <div class="member_right fl">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl" style="border: solid 1px #c5ddf5; border-bottom:0;">
      ...
      <tr>
        ...
        <td width="24%" align="center" valign="middle" bgcolor="#f3f3f3">备注</td>
      </tr>
      <tr>
        <td height="1" colspan="6" align="center" valign="middle" bgcolor="#ffffff"></td>
      </tr>
...
?>
      <tr>
        ...
        <td width="24%" height="36" align="center" valign="middle"><?php echo $row['memo'];?></td>
      </tr>
<?php
	}
?>     
    ...
    <div class="recharge_box fl" style="padding-top:5px;">
    	<p class="bold blue line36" style="border-bottom: dashed 1px #ccc;">支出交易笔数：<?php echo $count;?>　收入金额合计：<?php echo $sum['price'];?>元</p>
        <div class="manu mt15">
     ...
     3.如需要查询全部明细，请联系网站客服：<?php echo $data['site_config']['kf_phone_num2'];?>。</p>
    </div>
  </div>
</div>
<!--content1_end-->
