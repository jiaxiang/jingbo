...
<title><?php echo $site_config['site_title'];?>-会员中心-点卡充值</title>
...
<div class="paly_pop_ok" style="top:100px; left:120px;">
    ...
    <?php  print form::open ( 'user_recharge_card/recharge', array ('name' => 'formedit', 'id' => 'formedit' ) );?>
<table width="753" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td height="28" bgcolor="#faeee0" class="profile_bottom">&nbsp;</td>
		<td height="28" colspan="4" bgcolor="#faeee0" class="font14 profile_bottom orange"><strong>请填写卡上密码，每张充值卡只能使用一次！</strong></td>
	</tr>
	<tr>
	...
	<tr>
		<td width="2%">&nbsp;</td>
		<td width="13%" height="30" align="right" valign="middle"><span class="black">密码：</span></td>
		<td height="30" align="left" valign="middle">&nbsp;</td>
		<td height="30" align="left" valign="middle">
        <?php
			print form::input('card_pw', '', 'class="huiyuan_text_box" datatype="*10-18" nullmsg="请填写密码！" errormsg="密码错误！"');	 
		?>        		
		</td>
