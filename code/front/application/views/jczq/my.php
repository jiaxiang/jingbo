...
<title><?php echo $site_config['site_title'];?>-竞彩足球-我的方案</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jczq/rqspf"><font class="blue">竞彩足球</font></a> &gt; 我的方案
	</div>
...
<div class="width jingcai_box ">
	<div class="fl" id="jingcai_top">
     ...
     <div id="jingcai_bottom" class="fl"> 
	     <div class="dc_l"> <a href="<?php echo url::base();?>jczq/my/end" title="已结算交易" <?php if($status == 'end'){echo 'class="on"';}?>><em>已结算交易</em></a> <a href="<?php echo url::base();?>jczq/my/" <?php if($status == 'ing'){echo 'class="on"';}?> title="未结算交易"><em>未结算交易</em></a> </div>
	     <span class="fr pt5"><a href="<?php echo url::base();?>buycenter/jczq/"><img src="<?php echo url::base();?>media/images/btn3.gif" width="85" height="22" alt="参与合买" /></a></span></div>
