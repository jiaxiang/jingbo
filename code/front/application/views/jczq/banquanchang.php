...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jczq/rqspf"><font class="blue">竞彩足球</font></a> &gt; 半全场
	</div>
...
?>
    ...
    foreach ($groupvalue as $row) 
    {
		...
		$comb_show = array();
		$comb_show[] = $row['comb']->{'aa'}->{'v'};
		$comb_show[] = $row['comb']->{'ab'}->{'v'};
		$comb_show[] = $row['comb']->{'ac'}->{'v'};
		$comb_show[] = $row['comb']->{'ba'}->{'v'};
		$comb_show[] = $row['comb']->{'bb'}->{'v'};
		$comb_show[] = $row['comb']->{'bc'}->{'v'};
		$comb_show[] = $row['comb']->{'ca'}->{'v'};
		$comb_show[] = $row['comb']->{'cb'}->{'v'};
		$comb_show[] = $row['comb']->{'cc'}->{'v'};
    ?> 
...
<td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="33" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[0];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="31" class="chbox" type="checkbox"/><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[1];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="30" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[2];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="13" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[3];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="11" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[4];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="10" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[5];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="03" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[6];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="01" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[7];?></span></div></td>
                <td class="h_br" style="cursor: pointer;"><div class="label_br">
                    <?php if($row['match_end']==0) {?><input value="00" class="chbox" type="checkbox" /><?php }?>
                    <br />
                    <span class="eng b"><?php echo $comb_show[8];?></span></div></td>
...
?>
          ...
          <table class="dcr_table" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr id="choose_tpl2" style="display:none">
										<td class="tl" colspan="3"><span data-sg="33" class="x_sz">胜胜</span><span data-sg="31" class="x_sz">胜平</span><span data-sg="30" class="x_sz">胜负</span><span data-sg="13" class="x_sz">平胜</span><span data-sg="11" class="x_sz">平平</span><span data-sg="10" class="x_sz">平负</span><span data-sg="03" class="x_sz">负胜</span><span data-sg="01" class="x_sz">负平</span><span data-sg="00" class="x_sz">负负</span></td>
									  </tr>
            </tbody>
    ...
    <form name="project_form" id="project_form" action="/jczq/tobuy" method="post">
      ...
      <input id="play_method" name="play_method" value="4" type="hidden">
      <input id="ticket_id" name="ticket_id" value="4" type="hidden">
      <input id="playtype" name="playtype" value="bqc" type="hidden">
...
<div style="position: absolute; display: none; z-index: 9999;" id="livemargins_control"><img src="<?php echo url::base();?>media/images/monitor-background-horizontal.png" style="position: absolute; left: -77px; top: -5px;" height="5" width="77"> <img src="jczq_files/monitor-background-vertical.png" style="position: absolute; left: 0pt; top: -5px;"> <img id="monitor-play-button" src="jczq_files/monitor-play-button.png" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0.5" style="position: absolute; left: 1px; top: 0pt; opacity: 0.5; cursor: pointer;"></div>
