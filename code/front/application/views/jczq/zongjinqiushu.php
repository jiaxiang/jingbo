...
<title><?php echo $site_config['site_title'];?>-竞彩足球-总进球数</title>
...
(
	...
	'media/js/loginer',
	'media/js/detail',
	'media/js/jczq.js?v=201109160',
	'media/js/predict',
	//url::base().'xml/jczq/xml_2_2/load.js',
), FALSE);
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jczq/rqspf"><font class="blue">竞彩足球</font></a> &gt; 总进球数
	</div>
          ...
          <table class="dc_table" border="0" cellpadding="0" cellspacing="0" width="740">
            ...
            <tbody>
              <tr>
                ...
                <th class="last_th"><span class="eng">7+</span></th>
              </tr>
            </tbody>
          </table>
...
?>
    ...
    foreach ($groupvalue as $row) 
    {
		...
		$tmp = array();
		foreach ($row['comb'] as $key => $rowcomb)
		{
			$tmp_comb[] =  $rowcomb->v;				
		}		
    ?> 
    <tr class="<?php echo $rowstyle;?>" zid="<?php echo $row['id'];?>" mid="<?php echo $row['index_id'];?>" pname="<?php echo $row['match_num'];?>" pdate="<?php echo $row['match_num'];?>" lg="<?php echo $row['league'];?>" rq="<?php echo intval($row['goalline']);?>" pendtime="<?php echo date('Y-m-d H:i:s', strtotime($row['time_beg']));?>" odds="<?php echo implode(',', $tmp_comb);?>" isend="<?php echo $row['match_end']; ?>">
    ...
    <td class="h_br"><!-- 比分/析亚欧 -->
      ...
      <a href="<?php echo $ou_url;?>" target="_blank">欧</a>
        ...
        <?php if($row['match_end']==0) {?>
        <input value="<?php echo $key;?>" class="chbox" type="checkbox" />
        <?php }?>
        <span class="eng b"><?php echo $rowcomb->v;?></span></td>
        <?php
        }
        ?>    
        </tr>  
...
?>
      ...
      <div class="box_m">
        ...
        <div class="dc_r_m">
          ...
          <table class="dcr_table" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr style="display: none;" id="choose_tpl2">
                <td colspan="3" class="tl" style="padding-left: 5px;"><span class="x_sz" data-sg="0">0</span><span class="x_sz" data-sg="1">1</span><span class="x_sz" data-sg="2">2</span><span class="x_sz" data-sg="3">3</span><span class="x_sz" data-sg="4">4</span><span class="x_sz" data-sg="5">5</span><span class="x_sz" data-sg="6">6</span><span class="x_sz" data-sg="7">7</span></td>
              </tr>
            </tbody>
        ...
        <div class="dc_r_m">
          ...
          <p class="dc_qr">投注&nbsp;
            ...
            <a href="javascript:void(0);" id="seemore">查看明细</a>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" id="clear_all">清空所选</a></span></p>
          <p class="dc_r_btn">
    ...
    <form name="project_form" id="project_form" action="/jczq/tobuy" method="post">
      ...
      <input id="play_method" name="play_method" value="2" type="hidden">
      <input id="ticket_id" name="ticket_id" value="2" type="hidden">
      <input id="playtype" name="playtype" value="jqs" type="hidden">
