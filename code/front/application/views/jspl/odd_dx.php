...
<li class="hover"><span><a href="/jspl/odd_dx/<?=$match['match_id']?>">大小对比</a></span></li>
</ul>
</div>
</div>
<!--header end-->
...
<div class="toggler" id="toggler"></div>
  ...
  <tr>
    <td>
<div id="jc_menu" class="bold_laber">大小对比</div></td>
  </tr>
</table>
        </div>
        <div class="dc_l_m" id="vsTable">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="15" bgcolor="#f6fbff"><table class="dc_table" border="0" cellpadding="0" cellspacing="0" width="100%" id="datatb"><tr><td><table class="dc_table" border="0" cellpadding="0" cellspacing="0" width="100%" id="datatb2">
      <tbody>
        <tr id="2" class="tr2">
          <th class="th_one"><label>全选</label></th>
          <th>公司</th>
          <th width="55">大球</th>
          <th>即时</th>
          <th width="55">小球</th>
...
?>
<tr id="tr_<?=$pl[$i]['company_id']?>" tipid="<?=$pl[$i]['company_id']?>" style="">
          <td class="td_one"><?=$i+1?></td>
          <td><?=jspl::getCompanyName($pl[$i]['company_id'])?> </td>
          <td class=""><span class="" id="span_big_1" onclick=""><?=$pl[$i]['js_d_sp']?></span></td>
          <td style="cursor: pointer;"><?=$pl[$i]['js_pk']?></td>
          <td class=""><span class="" id="span_small_1" onclick=""><?=$pl[$i]['js_x_sp']?></span></td>
          <td><?=$pl[$i]['time']?></td>
          <td><?=$pl[$i]['first_d_sp']?></td>
          <td><?=$pl[$i]['first_pk']?></td>
          <td><?=$pl[$i]['first_x_sp']?></td>
          <td><?=$pl[$i]['time']?></td>
        </tr>
<?php
} 
?>
      ...
      <tr class="tr3">
        ...
        <td bgcolor="#FFFFCC" id="firstlargemax"><?=$js_d_sp_max['js_d_sp']?></td>
        <td bgcolor="#FFFFCC" id="jishimax"><?=$js_pk_max['js_pk']?></td>
        <td bgcolor="#FFFFCC" id="firstsmallmax"><?=$js_x_sp_max['js_x_sp']?></td>
        <td bgcolor="#FFFFCC" id="firsttimemax"></td>
        <td bgcolor="#FFFFCC" id="secondlargemax"><?=$first_d_sp_max['first_d_sp']?></td>
        <td bgcolor="#FFFFCC" id="chupanmax"><?=$first_pk_max['first_pk']?></td>
        <td bgcolor="#FFFFCC" id="secondsmallmax"><?=$first_x_sp_max['first_x_sp']?></td>
        <td bgcolor="#FFFFCC" id="secondtimemax"></td>
        <td bgcolor="#FFFFCC">&nbsp;</td>
      </tr>
      <tr class="tr3">
        <td colspan="2" bgcolor="#FFFFCC">最小值</td>
        <td bgcolor="#FFFFCC" id="firstlargemin"><?=$js_d_sp_min['js_d_sp']?></td>
        <td bgcolor="#FFFFCC" id="jishimin"><?=$js_pk_min['js_pk']?></td>
        <td bgcolor="#FFFFCC" id="firstsmallmin"><?=$js_x_sp_min['js_x_sp']?></td>
        <td bgcolor="#FFFFCC" id="firsttimemin"></td>
        <td bgcolor="#FFFFCC" id="secondlargemin"><?=$first_d_sp_min['first_d_sp']?></td>
        <td bgcolor="#FFFFCC" id="chupanmin"><?=$first_pk_min['first_pk']?></td>
        <td bgcolor="#FFFFCC" id="secondsmallmin"><?=$first_x_sp_min['first_x_sp']?></td>
        <td bgcolor="#FFFFCC" id="secondtimemin"></td>
        <td bgcolor="#FFFFCC">&nbsp;</td>
      </tr>
    </table></td>
        </tr>
