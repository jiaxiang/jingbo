...
<title><?php echo $site_config['site_title'];?>-七星彩-购买成功</title>
...
<!--menu和列表_end-->
<!--面包屑导航-->
<div class="width line36 gray68">您所在的位置：<a href="/"><font class="blue">首页</font></a> &gt; 七星彩</div>
<!--面包屑导航_end-->
<!--content1-->
<!--content1 end-->
<!--header end-->
    ...
    <div class="sec_lr clearfix">
      <div class="sec_l">
        <div class="sec_box">
          <div class="sec_n_b">
            <div class="sec_info">
              <h2> <span>您的方案已提交成功！</span> <a href="/qxc">返回继续购买</a> </h2>
              <p>您的账户余额为 <span class="eng red">￥<?php echo $usermoney;?></span> 元<br>
                您可以继续去 <a href="<?php echo '/qxc/view/'.$id;?>">查看方案详情</a> <a href="/user/betting">我的购买记录</a></p>
            </div>
            <div class="add_to clearfix">
              <input value="<?php echo url::base();?><?php echo '/qxc/view/'.$id;?>" id="writeHiddenUrl" name="writeHiddenUrl" type="hidden">
              <div class="add_to_l">您的方案编号是：<a href="<?php echo '/qxc/view/'.$id;?>"><?php echo $basic_id;?></a> <a href="javascript:void(0);" onclick="copyurl('<?php echo url::base();?><?php echo '/qxc/view/'.$id;?>')" id="copystr">点击复制</a></div>
              <div class="add_to_r">
               <?php
			   /**
			   ?>
