...
<title><?php echo $site_config['site_title'];?>-排列五-订单详情</title>
		...
		<div id="main">
            ...
            <div class="box_m">
              <div class="det_t_bg">
					...
					<div id="lot-logo" class="s-logo plw-logo"></div>
               	<div class="det_h">
                    	<h2>排列五 第<?php echo $qihao; ?>期   <?php echo $wtype=1?"复式":"单式";?>
                  ...
                  <a id="hmlist" class="m_link" href="/buycenter/lottnumpub/9/">返回合买列表&gt;&gt;</a>
                </div>
