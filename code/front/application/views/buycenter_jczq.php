...
<title><?php echo $site_config['site_title'];?>-竞彩足球-合买大厅</title>
...
var submit_url="jczq/viewdetail_join/";
var submit_url_join="jczq/submit_buy_join";
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jczq/rqspf"><font class="blue">竞彩足球</font></a> &gt; 合买大厅
	</div>
...
<div id="bd" class="clearfix m-t"> <?php echo View::factory('buycenter_menu')->render();?>
  <div id="container">
    <div class="hmzx-top"><span class="l"><strong>竞彩足球合买方案</strong><span>&nbsp;&nbsp;<span id="endtimelist">截止时间：赛前20分钟</span></span></span><a href="/jczq/rqspf/" title="" class="r" target="_blank">发起合买&gt;&gt;</a></div>
    <div class="hm-plan">
      <div class="content">
        <div class="c-wrap">
          <div class="c-inner">
