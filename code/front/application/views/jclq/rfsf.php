...
<title><?php echo $site_config['site_title'];?>-竞彩篮球-让分胜负</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jclq/rfsf"><font class="blue">竞彩篮球</font></a> &gt; 让分胜负
	</div>
...
<div class="dc_l_m" id="vsTable">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="dc_table" >
		<colgroup>
			<col width="10%" />
			<col width="10%" />
			<col width="8%" />
		...
		<tbody>
			<tr class="">
				...
				<th>赛事类型</th>
				<th>
				<select id="select_time" style="font-size:12px; width:48px;">
...
?> 
		<tr class="<?php echo $rowstyle;?>" 
			...
			hometeam="<?php echo $row['host_name'];?>(<?php echo $row['goalline']?>)" 
			...
			<td>
				...
				<input checked="checked" value="<?php echo $row['id'];?>" id="m<?php echo $row['id'];?>" name="<?php echo $row['id'];?>" class="i-cr" type="checkbox" /><?php echo $row['match_info'];?>
				</label>
			</td>
			...
			<td class="h_br">
				...
				<a href="http://info.sporttery.cn/basketball/hdc_odds.php?mid=<?php echo $row['match_id'];?>" target="_blank">同</a>
			</td>
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="dcr_table">
				...
				<tbody>
					...
					<tr id="choose_tpl" style="display: none;">
						<td><input type="checkbox" class="chbox" checked="checked" view="1" /><span>周三001</span></td>
						<td class="tl">凯尔特人</td>
						<td class="tl"><span class="x_s" data-sg="2">让分主负</span><span class="x_s" data-sg="1">让分主胜</span></td>
						<td><span><input type="checkbox" class="chbox" dan="1" /></span></td>
					</tr>
				</tbody>
			
				<tbody id="choose_list">
					<tr id="choose_10114" style="display:none;" mid="10114" pname="4301" dan="0">
						<td><input type="checkbox" class="chbox" checked="checked" view="1" /><span>周四301</span></td>
						<td class="tl">喀山</td>
						<td class="tl">
							<span class="x_s" data-sg="2" style="display: none; ">让分主负</span>
							<span class="x_s" data-sg="1" style="display: none; ">让分主胜</span>
						</td>
						<td><span><input type="checkbox" class="chbox" dan="1" disabled="" /></span></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="tips_b">
		<div class="tips_box">
			<div class="tips_title" style=" cursor: move; ">
				<h2>竞彩篮球奖金明细</h2>
				<span class="close"><a id="close1" href="javascript:void(0)">关闭</a></span>
			</div>
			<div class="tips_info" style="height: 470px; overflow-y: auto; overflow-x: hidden; ">
				<div class="mx_tips">
...
<form name="project_form" id="project_form" action="/jclq/tobuy" method="post">
	...
	<input type="hidden" id="play_method" name="play_method" value="2" />
	<input type="hidden" id="ticket_id" name="ticket_id" value="2" />
	<input type="hidden" id="playtype" name="playtype" value="rfsf" />
...
<!--<input type="hidden" id="jsonggtype" value="{&#39;单关&#39;:40,&#39;2串1&#39;:1,&#39;2串3&#39;:2,&#39;3串1&#39;:3,&#39;3串3&#39;:56,&#39;3串4&#39;:4,&#39;3串6&#39;:5,&#39;3串7&#39;:6,&#39;4串1&#39;:7,&#39;4串4&#39;:8,&#39;4串5&#39;:9,&#39;4串6&#39;:10,&#39;4串10&#39;:11,&#39;4串11&#39;:12,&#39;4串14&#39;:13,&#39;4串15&#39;:14,&#39;5串1&#39;:15,&#39;5串5&#39;:16,&#39;5串6&#39;:17,&#39;5串10&#39;:18,&#39;5串15&#39;:19,&#39;5串16&#39;:20,&#39;5串20&#39;:21,&#39;5串25&#39;:22,&#39;5串26&#39;:23,&#39;5串30&#39;:24,&#39;5串31&#39;:25,&#39;6串1&#39;:26,&#39;6串6&#39;:27,&#39;6串7&#39;:28,&#39;6串15&#39;:29,&#39;6串20&#39;:30,&#39;6串21&#39;:31,&#39;6串22&#39;:57,&#39;6串35&#39;:32,&#39;6串41&#39;:33,&#39;6串42&#39;:34,&#39;6串50&#39;:35,&#39;6串56&#39;:36,&#39;6串57&#39;:37,&#39;6串62&#39;:38,&#39;6串63&#39;:39,&#39;7串1&#39;:41,&#39;7串7&#39;:42,&#39;7串8&#39;:43,&#39;7串21&#39;:44,&#39;7串35&#39;:45,&#39;7串120&#39;:46,&#39;7串127&#39;:47,&#39;8串1&#39;:48,&#39;8串8&#39;:49,&#39;8串9&#39;:50,&#39;8串28&#39;:51,&#39;8串56&#39;:52,&#39;8串70&#39;:53,&#39;8串247&#39;:54,&#39;8串255&#39;:55,&#39;未上传&#39;:-1}" />-->
<!--<input type="hidden" id="playtype" value="rfsf" />-->
<!--<input type="hidden" id="isgg" value="2" />-->
...
<div style="position: absolute; display: none; z-index: 9999;" id="livemargins_control">
	<img src="jclq_spf_files/monitor-background-horizontal.png" style="position: absolute; left: -77px; top: -5px;" height="5" width="77" />
	<img src="jclq_spf_files/monitor-background-vertical.png" style="position: absolute; left: 0pt; top: -5px;" /> 
	<img id="monitor-play-button" src="jclq_spf_files/monitor-play-button.png" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0.5" style="position: absolute; left: 1px; top: 0pt; opacity: 0.5; cursor: pointer;" />
</div>
