...
<title><?php echo $site_config['site_title'];?>-竞彩篮球-大小分</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jclq/rfsf"><font class="blue">竞彩篮球</font></a> &gt; 大小分
	</div>
...
?>
	<div class="dc_hs">
		<strong><?php echo $groups_date[$groupkey];?><?php echo tool::get_weekday($groups_date[$groupkey]);?>&nbsp;
		<?php echo count($groupvalue);?>场比赛可投注</strong>&nbsp;<a href="javascript:void(0)">隐藏<s class="c_up"></s></a>
	</div>
...
?> 
		<tr class="<?php echo $rowstyle;?>" 
			...
			big="<?php echo $row['comb']->h->v;?>" 
			small="<?php echo $row['comb']->a->v;?>" 
	...
	<?php echo date('H:i', strtotime($row['time_beg']));?></span> 
			...
			<td class="tr"><span class="gray"></span><?php echo $row['guest_name'];?></td>
			<td><span class="eng b"><?php echo $row['goalline'];?></span></td>
			<td class="tl h_br"><?php echo $row['host_name'];?></td>
	...
	<div class="box_m">
		...
		<div class="dc_r_m">
			...
			<tr id="choose_tpl" style="display: none;">
				<td>
					<input class="chbox" checked="checked" view="1" type="checkbox" />
					<span>周三001</span>
				</td>
				<td class="tl">凯尔特人</td>
				<td class="tl">
					<span class="x_s" data-sg="1">大分</span>
					<span class="x_s" data-sg="2">小分</span>
				</td>
				<td>
					<span><input class="chbox" dan="1" type="checkbox" /></span>
				</td>
			</tr>
			</tbody>
		...
		<div class="dc_r_m">
			...
			<div id="ggListFree" class="ggtypelist clearfix">
				...
				<label style="display:none;" for="r7c1"><input name="ggtype_checkbox" id="r7c1" value="7串1" type="checkbox" />7串1</label>
				<label style="display:none;" for="r8c1"><input name="ggtype_checkbox" id="r8c1" value="8串1" type="checkbox" />8串1</label>
			</div>
		</div>
		<div id="ggList" class="ggtypelist clearfix" style="display:none">
			<label for="r3c3" style="display: none;"><input name="ggtype_radio" value="3串3" id="r3c3" type="radio" />3串3</label>
			<label for="r3c4" style="display: none;"><input name="ggtype_radio" value="3串4" id="r3c4" type="radio" />3串4</label>
			<label for="r4c4" style="display: none;"><input name="ggtype_radio" value="4串4" id="r4c4" type="radio" />4串4</label>
			<label for="r4c5" style="display: none;"><input name="ggtype_radio" value="4串5" id="r4c5" type="radio" />4串5</label>
			<label for="r4c6" style="display: none;"><input name="ggtype_radio" value="4串6" id="r4c6" type="radio" />4串6</label>
			<label for="r4c11" style="display: none;"><input name="ggtype_radio" value="4串11" id="r4c11" type="radio" />4串11</label>
			<label for="r5c5" style="display: none;"><input name="ggtype_radio" value="5串5" id="r5c5" type="radio" />5串5</label>
			<label for="r5c6" style="display: none;"><input name="ggtype_radio" value="5串6" id="r5c6" type="radio" />5串6</label>
			<label for="r5c10" style="display: none;"><input name="ggtype_radio" value="5串10" id="r5c10" type="radio" />5串10</label>
			<label for="r5c16" style="display: none;"><input name="ggtype_radio" value="5串16" id="r5c16" type="radio" />5串16</label>
			<label for="r5c20" style="display: none;"><input name="ggtype_radio" value="5串20" id="r5c20" type="radio" />5串20</label>
			<label for="r5c26" style="display: none;"><input name="ggtype_radio" value="5串26" id="r5c26" type="radio" />5串26</label>
			<label for="r6c6" style="display: none;"><input name="ggtype_radio" value="6串6" id="r6c6" type="radio" />6串6</label>
			<label for="r6c7" style="display: none;"><input name="ggtype_radio" value="6串7" id="r6c7" type="radio" />6串7</label>
			<label for="r6c15" style="display: none;"><input name="ggtype_radio" value="6串15" id="r6c15" type="radio" />6串15</label>
			<label for="r6c20" style="display: none;"><input name="ggtype_radio" value="6串20" id="r6c20" type="radio" />6串20</label>
			<label for="r6c22" style="display: none;"><input name="ggtype_radio" value="6串22" id="r6c22" type="radio" />6串22</label>
			<label for="r6c35" style="display: none;"><input name="ggtype_radio" value="6串35" id="r6c35" type="radio" />6串35</label>
			<label for="r6c42" style="display: none;"><input name="ggtype_radio" value="6串42" id="r6c42" type="radio" />6串42</label>
			<label for="r6c50" style="display: none;"><input name="ggtype_radio" value="6串50" id="r6c50" type="radio" />6串50</label>
			<label for="r6c57" style="display: none;"><input name="ggtype_radio" value="6串57" id="r6c57" type="radio" />6串57</label>
			<label for="r7c7" style="display: none;"><input name="ggtype_radio" value="7串7" id="r7c7" type="radio" />7串7</label>
			<label for="r7c8" style="display: none;"><input name="ggtype_radio" value="7串8" id="r7c8" type="radio" />7串8</label>
			<label for="r7c21" style="display: none;"><input name="ggtype_radio" value="7串21" id="r7c21" type="radio" />7串21</label>
			<label for="r7c35" style="display: none;"><input name="ggtype_radio" value="7串35" id="r7c35" type="radio" />7串35</label>
			<label for="r7c120" style="display: none;"><input name="ggtype_radio" value="7串120" id="r7c120" type="radio" />7串120</label>
			<label for="r8c8" style="display: none;"><input name="ggtype_radio" value="8串8" id="r8c8" type="radio" />8串8</label>
			<label for="r8c9" style="display: none;"><input name="ggtype_radio" value="8串9" id="r8c9" type="radio" />8串9</label>
			<label for="r8c28" style="display: none;"><input name="ggtype_radio" value="8串28" id="r8c28" type="radio" />8串28</label>
			<label for="r8c56" style="display: none;"><input name="ggtype_radio" value="8串56" id="r8c56" type="radio" />8串56</label>
			<label for="r8c70" style="display: none;"><input name="ggtype_radio" value="8串70" id="r8c70" type="radio" />8串70</label>
			<label for="r8c247" style="display: none;"><input name="ggtype_radio" value="8串247" id="r8c247" type="radio" />8串247</label>
		</div>
        <div class="dc_r_m">
			<h2>3、确认投注结果</h2>
			<p class="dc_qr"> 投注&nbsp;
...
<!--	<input type="hidden" id="playid" name="playid" value="276" />-->
	...
	<input type="hidden" id="play_method" name="play_method" value="4" />
	<input type="hidden" id="ticket_id" name="ticket_id" value="4" />
	<input type="hidden" id="playtype" name="playtype" value="dxf" />
...
<div style="position: absolute; display: none; z-index: 9999;" id="livemargins_control">
	...
	<img id="monitor-play-button" src="jclq_spf_files/monitor-play-button.png" 
