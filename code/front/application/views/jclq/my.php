...
<title><?php echo $site_config['site_title'];?>-竞彩篮球-我的方案</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jclq/rfsf"><font class="blue">竞彩篮球</font></a> &gt; 我的方案
	</div>
...
<div class="width jingcai_box ">
	<div class="fl" id="jingcai_top">
    	<span class="fl" id="jctop_left"><img src="<?php echo url::base();?>media/images/jclq-logo.png" height="63" /></span>
     ...
     <div id="jingcai_bottom" class="fl"> 
	     <div class="dc_l"> <a href="<?php echo url::base();?>jclq/my/end" title="已结算交易" <?php if($status == 'end'){echo 'class="on"';}?>><em>已结算交易</em></a> <a href="<?php echo url::base();?>jclq/my/" <?php if($status == 'ing'){echo 'class="on"';}?> title="未结算交易"><em>未结算交易</em></a> </div>
	     <span class="fr pt5"><a href="<?php echo url::base();?>buycenter/jclq/"><img src="<?php echo url::base();?>media/images/btn3.gif" width="85" height="22" alt="参与合买" /></a></span></div>
...
<?php echo View::factory('footer')->render();?>
 ...
 <div id="ft">
  ...
  <!--未登录提示层-->
  <div class="tips_m" style="display: none; width: 360px; position: absolute; left: -99999px;" id="loginLay">
    <div class="tips_b">
      <div class="tips_box">
        ...
        <div class="tips_text">
          ...
          <form method="post" action="http://passport..com/login/login.php" onsubmit="return false;" id="loginForm">
            <table class="dl_tbl" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tbody>
                <tr>
                  <td>用户名：</td>
                  <td><input class="tips_txt text_on" id="lu" name="u" type="text"></td>
                  <td class="t_ar"><a href="http://passport..com/user/" target="_blank" tabindex="-1">免费注册</a></td>
                </tr>
                <tr>
                  <td>密&nbsp;&nbsp;码：</td>
                  <td><input class="tips_txt" id="lp" name="p" type="password"></td>
                  <td class="t_ar"><a href="http://passport..com/user/getpwd.php" target="_blank" tabindex="-1">忘记密码</a></td>
                </tr>
                <tr>
                  <td>验证码：</td>
                  <td colspan="2"><input class="tips_yzm" id="yzmtext" name="c" type="text">
                    <img alt="验证码" src="<?php echo url::base();?>media/images/a" id="login_secoder" style="cursor: pointer; display: none; width: 60px; height: 25px;"><a class="kbq" href="javascript:void%200" id="yzmup">看不清，换一张</a></td>
                </tr>
                <tr>
                  <td></td>
                  <td colspan="2"><input class="btn_Dora_b" value="登 录" id="floginbtn" style="margin-right: 18px;" type="button">
                    <a href="javascript:void%200" id="tenpaylogin">QQ登录</a> <span class="gray">|</span> <a href="javascript:void%200" id="zfblogin">支付宝登录</a></td>
                  <td></td>
                </tr>
              </tbody>
            </table>
