...
<title><?php echo $site_config['site_title'];?>-竞彩篮球-购买成功</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jclq/rfsf"><font class="blue">竞彩篮球</font></a> &gt; 购买成功
	</div>
    ...
    <div class="sec_lr clearfix">
      <div class="sec_l">
        <div class="sec_box">
          <div class="sec_n_b">
            <div class="sec_info">
              <h2> <span>您的方案已提交成功！</span> <a href="/jclq/sf/">返回继续购买</a> </h2>
              <p>您的账户余额为 <span class="eng red">￥<?php echo $usermoney;?></span> 元<br>
                您可以继续去 <a href="<?php echo '/jclq/viewdetail/'.$basic_id;?>">查看方案详情</a> <a href="/user/betting">我的购买记录</a></p>
            </div>
            <div class="add_to clearfix">
              <input value="<?php echo url::base();?><?php echo '/jclq/plan/'.$id;?>" id="writeHiddenUrl" name="writeHiddenUrl" type="hidden">
              <div class="add_to_l">您的方案编号是：<a href="<?php echo '/jclq/viewdetail/'.$basic_id;?>"><?php echo $basic_id;?></a> <a href="javascript:void(0);" onclick="copyurl('<?php echo url::base();?><?php echo '/jclq/viewdetail/'.$basic_id;?>')" id="copystr">点击复制</a></div>
              <div class="add_to_r">
               <?php
			   /**
			   ?>
