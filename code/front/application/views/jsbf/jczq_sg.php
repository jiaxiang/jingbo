...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
<title><?php echo $site_config['site_title'];?>-赛果查询-竞彩足球</title>
...
<li><span><a href="/jsbf/sg_select/zc">足彩赛果</a></span></li>
<li class="hover"><span><a href="/jsbf/sg_select/jc">竞彩赛果</a></span></li>
</ul>
</div>
</div>
<!--header end-->
    ...
    <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        for ($i = 0; $i < 5; $i++) {
        	...
        	$href = '/jsbf/sg_select/jc/'.date('Y-m-d',$mk);
        	$selected = '';
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<span><a class="topmya now" href="<?php echo url::base();?>jsbf/"><b>旧版即时比分入口</b></a></span>
        </td>
