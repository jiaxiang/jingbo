...
<title><?php echo $site_config['site_title'];?>-赛果查询-所有赛事</title>
...
<ul>
<li class="hover"><span><a href="/jsbf/sg_select/all">所有赛果</a></span></li>
    ...
    <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        for ($i = 0; $i < 5; $i++) {
        	...
        	$href = '/jsbf/sg_select/all/'.date('Y-m-d',$mk);
        	$selected = '';
