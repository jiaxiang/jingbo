    ...
    <div id="main">
      ...
      <div class="box_m">
        <div id="xx1" style="display:;">
          <table class="pub_table" id="vsTable" width="100%" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <th width="35">场次</th>
                <th width="75">赛事</th>
                ...
                <th width="198">对阵</th>
                <th width="70">数据</th>
                <th width="150"> <table class="th_table" width="114" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                ...
                <th width="151"> <table class="th_table" width="120" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <th colspan="3">选号区</th>
                      </tr>
                ...
                <th width="43">全包</th>
                <th class="last_th"> <table class="th_table" width="120" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
 			...
 			<?php foreach($expect_list as $key=>$value){?>
              ...
              <td id="index_0_0"><span class="sp_w38 eng"><?php echo $zcsf_h?></span><span class="sp_w38 eng"><?php echo $zcsf_d?></span><span class="sp_w38 eng"><?php echo $zcsf_a?></span></td>
                <td id="index_1_0" style="display: none;"><span class="sp_w38 eng">1.14</span><span class="sp_w70">半球</span><span class="sp_w38 eng">0.72</span></td>
                <td id="index_2_0" style="display: none;"><span class="sp_w38 eng">0.93</span><span class="sp_w38 eng">0.93</span><span class="sp_w38 eng">0.93</span></td>
                <td id="index_3_0" style="display: none;"><span class="sp_w38 eng">21.92</span><span class="sp_w38 eng">13.83</span><span class="sp_w38 eng">32.16</span></td>
                ...
                <td class="last_td"><span class="sp_w40 eng">37%</span><span class="sp_w40 eng">33%</span><span class="sp_w40 eng">30%</span></td>
              </tr>
 			<?php } ?>
          ...
          <table class="buy_table" width="100%" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              ...
              <tr class="last_tr">
                ...
                <td class="td_content"><div class="buy_btn"> <a href="/zcsf/shxh_9c/<?php echo $detail['basic_id'];?>" class="btn_buy_m" title="立即购买" id="buy_hm">立即购买</a> </div></td>
              </tr>
            </tbody>
          </table>
        </div>
...
<!--倍数-->
<input name="anumber" id="anumber" value="<?php echo $detail['copies'];?>" type="hidden">
<!--份数-->
<input name="baodinum" id="baodinum" value="<?php echo $detail['end_price'];?>" type="hidden">
<!--保底金额数-->
