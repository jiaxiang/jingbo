...
<title><?php echo $site_config['site_title'];?>-足彩胜负-9场胜负彩</title>
...
?>                 </span><span>单注最高奖金<b class="red">5,000,000</b>元<b class="kj"></b></span></dt>
  ...
  <div id="jingcai_bottom" class="fl">
    <div class="dc_l"> <a href="<?php echo url::base();?>zcsf/sfc_9c/<?php echo $cur_expect;?>" title="普通投注" class="on"><em>普通投注</em><s></s></a> <a href="<?php echo url::base();?>zcsf/sfc_9c_ds/<?php echo $cur_expect;?>" title="单式投注" ><em>单式投注</em><s></s></a> </div>
  ...
  <div id="main">
    ...
    <div class="box_m">
      <div class="top_selt"> <span>选号方式：</span>
        <label onclick="self.location='<?php echo url::base();?>zcsf/sfc_9c/<?php echo $cur_expect;?>'" class="cur_lab">
          <input name="isyt" id="radio" value="0" checked="checked" class="rdo" type="radio">
          现在选号 </label>
        <label onclick="self.location='<?php echo url::base();?>zcsf/sfc_9c_shxh/<?php echo $cur_expect;?>'">
      ...
      <div id="xx1" style="display:;">
        <table class="pub_table" id="vsTable" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <th width="141"> <table class="th_table" border="0" cellpadding="0" cellspacing="0" width="120">
                  <tbody>
                    <tr>
                      <th colspan="3">选号区</th>
                    </tr>
        ...
        <div>
          ...
          <div id="dd2" style="display:none;"> <?php echo View::factory('zcsf/public_form')->render();?> </div>
        </div>
      </div>
    </div>
  </div>
