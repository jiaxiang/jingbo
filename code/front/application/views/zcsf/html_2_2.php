...
<title><?php echo $site_config['site_title'];?>-足彩胜负-9场胜负彩-稍后选号</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>zcsf/sfc_14c"><font class="blue">足彩胜负</font></a> &gt; 9场胜负彩
	</div>
...
?>
<a data-val="<?php echo $value;?>"<?php if ($value==$cur_expect) {?> class="on"<?php } ?> title="当前期<?php echo $value;?>期" href="/zcsf/sfc_9c/<?php echo $value;?>">当前期<?php echo $value;?>期</a>|
<?php 
		}
		else { 
			if ($value == '12007') $expect_name = '当前'; else $expect_name = '预售';
?>    
<a data-val="<?php echo $value;?>"<?php if ($value==$cur_expect) {?> class="on"<?php } ?> title="<?php echo $expect_name;?>期<?php echo $value;?>期" href="/zcsf/sfc_9c/<?php echo $value;?>"><?php echo $expect_name;?>期<?php echo $value;?>期</a>|
<?php 
		}
	} 
?>				</span><span>单注最高奖金<b class="red">5,000,000</b>元<b class="kj"></b></span></dt>
      ...
      <div id="jc_menu" class="font14 bold">
            	<ul>
                	<li><a href="/zcsf/sfc_14c/<?php echo $cur_expect;?>"><span>十四场胜负彩</span></a></li>
                    <li ><a href="/zcsf/sfc_4c"><span>进球彩</span></a></li>
				    <li class="hover" ><a href="/zcsf/sfc_9c/<?php echo $cur_expect;?>"><span>九场胜负彩</span></a></li>
       				 <li><a href="/zcsf/sfc_6c"><span>六场半全</span></a></li>                                           
                    <li ><a href="/zcsf/mycase_9c"><span>我的方案</span></a></li>
                </ul>
          </div>
        </div>
    </div>
     <div id="jingcai_bottom" class="fl"> 
	     <div class="dc_l">
		     <a href="<?php echo url::base();?>zcsf/sfc_9c/<?php echo $cur_expect;?>" title="普通投注" class="on"><em>普通投注</em><s></s></a>
			 <a href="<?php echo url::base();?>zcsf/sfc_9c_ds/<?php echo $cur_expect;?>" title="单式投注" ><em>单式投注</em><s></s></a>
		 </div>
  ...
  <div id="main">
    ...
    <div class="box_m">
      <div class="top_selt"> <span>选号方式：</span>
        <label <?php if($cur_expect==$expect_data['expects'][0]) {?>onclick="self.location='<?php echo url::base();?>zcsf/sfc_9c/<?php echo $cur_expect;?>'"<? } ?>>
        ...
        现在选号 </label>
        <label onclick="self.location='<?php echo url::base();?>zcsf/sfc_9c_shxh/<?php echo $cur_expect;?>'" class="cur_lab">
      ...
      <div id="xx2">
        <table class="pub_table" id="vsTable" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <th width="198">对阵</th>
              <th width="70">数据</th>
              <th width="250"> <table class="th_table" border="0" cellpadding="0" cellspacing="0" width="114">
                  <tbody>
                    <tr>
		...
		<?php foreach($expect_list as $key=>$value){ ?>  
              ...
              ?>
                    <td id="index_0_<?php echo $key;?>"><span class="sp_w38 eng"><?php echo $zcsf_h?></span><span class="sp_w38 eng"><?php echo $zcsf_d?></span><span class="sp_w38 eng"><?php echo $zcsf_a?></span></td>
					<td id="index_1_<?php echo $key;?>" style="display:none"><span class="sp_w38 eng">0.90</span><span class="sp_w70">受平手/半球</span><span class="sp_w38 eng">0.99</span></td>
					<td id="index_2_<?php echo $key;?>" style="display:none"><span class="sp_w38 eng">0.91</span><span class="sp_w70">0.91</span><span class="sp_w38 eng">0.91</span></td>
					<td id="index_3_<?php echo $key;?>" style="display:none"><span class="sp_w38 eng">32.17</span><span class="sp_w70">15.47</span><span class="sp_w38 eng">10.58</span></td>   
                    <td class="last_td"><span class="sp_w90 eng">25%</span><span class="sp_w90 eng">33%</span><span class="sp_w90 eng">42%</span></td>
                  </tr>                  
		<?php } ?> 
          ...
          <tbody>
            <tr>
              ...
              <td class="td_content"><p id="prevInput"><span class="hide_sp"></span><span class="align_sp">三选个数：</span>
                  ...
                  <input name="" class="mul" value="0" type="text">
                  单选个数：
                  <input name="" class="mul" value="14" type="text">
                  <span class="gray" id="prevSpan">(三选 + 双选 + 单选个数总和 = <span id="max">9</span>)</span></p>
                <p><span class="hide_sp"></span><span class="align_sp">您选择了：</span>
                  <input maxlength="7" name="" class="mul" value="1" id="bsInput" type="text">
                  倍 </p>
                <p><span class="hide_sp"></span><span class="align_sp">方案注数：</span><span class="red" id="zsSpan">1</span>注，金额：<span class="red eng" id="moneySpan">￥2.00</span>元 <span class="tips_sp" id="moneyErr" style="display:none">复式投注最大限制金额为20万元！</span><span class="tips_sp" id="sizeErr" style="display:none">胜负彩复式预投个数总和必须有14个，请修改！</span></p></td>
            </tr>
          </tbody>
        </table>
...
<input name="title" id="title" value="<?php echo $cur_expect;?>期9场任选" type="hidden">
