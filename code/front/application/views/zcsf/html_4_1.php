...
<title><?php echo $site_config['site_title'];?>-足彩胜负-4场进球彩</title>
  ...
  <div id="main">
    ...
    <div class="box_m">
      <div class="top_selt"> <span>选号方式：</span>
        <label onclick="self.location='<?php echo url::base();?>zcsf/sfc_4c/<?php echo $cur_expect;?>'" class="cur_lab">
              ...
              <tbody>
                <tr class="last_tr">
                  ...
                  <td class="td_content"><div class="buy_info">
                      <p id="userMoneyInfo">您尚未登录，请先<a href="" title="" onclick="Yobj.postMsg('msg_login')">登录</a>!</p>
                      ...
                      <p><span class="hide_sp">
                        ...
                        </span>我已阅读并同意《<a href="" onclick="Y.openUrl('/doc/webdoc/gmxy',530,550)">用户合买代购协议</a>》</p>
                    </div>
                    <div class="buy_btn"> <!--a href="" class="btn_buy_m" title="立即购买" id="buy_dg">立即购买</a--> </div></td>
                </tr>
              </tbody>
            </table>
          </div>
