...
<title><?php echo $site_config['site_title'];?>-足彩胜负-14场胜负彩-稍后选号</title>
  ...
  <div id="main">
    ...
    <div class="box_m">
      <div class="top_selt"> <span>选号方式：</span>
        ...
        <label <?php if($cur_expect==$expect_data['expects'][0]) {?>onclick="self.location='<?php echo url::base();?>zcsf/sfc_14c/<?php echo $cur_expect;?>'"<? } ?>>
        <input name="isyt" id="radio" value="0" class="rdo" type="radio"<?php if($cur_expect!=$expect_data['expects'][0] or strtotime($expect_data['start_time'])>time() or $expect_data['buy_status']==0) {echo 'disabled="true"';}?>>
        现在选号 </label>
        <label onclick="self.location='<?php echo url::base();?>zcsf/sfc_14c_shxh/<?php echo $cur_expect;?>'" class="cur_lab">
          ...
          <tbody>
            <tr>
              ...
              <td class="td_content"><p id="prevInput"><span class="hide_sp"></span><span class="align_sp">三选个数：</span>
                  ...
                  <span class="gray" id="prevSpan">(三选 + 双选 + 单选个数总和 = <span id="max">14</span>)</span></p>
...
<input name="title" id="title" value="<?php echo $cur_expect;?>期胜负彩" type="hidden">
