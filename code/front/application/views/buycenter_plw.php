...
<title><?php echo $site_config['site_title'];?>-排列五-合买大厅</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>plw"><font class="blue">排列五</font></a> &gt; 合买大厅
	</div>
...
<div id="bd" class="clearfix m-t"> <?php echo View::factory('buycenter_menu')->render();?>
  ...
  <div id="container">
    <div class="hmzx-top"><span class="l"><strong>排列五合买方案</strong><?php if($isnow){?><span>第<b><?php echo $isnow['qihao'];?></b>期&nbsp;&nbsp;<span id="endtimelist">截止时间：<?php echo $isnow['fendtime']?>（单式：<?php echo $isnow['dendtime']?>）
    ...
    <a href="/plw" title="" class="r" target="_blank">发起合买&gt;&gt;</a></div>
    <div class="hm-plan">
      <div class="content">
        <div class="c-wrap">
          <div class="c-inner">
