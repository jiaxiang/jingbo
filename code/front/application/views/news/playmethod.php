...
<title><?php echo $site_config['site_title'];?>-玩法介绍</title>
...
<div id="recommend" class="fl mt5">
    	<p id="recommend_tit">您所在的位置：<span class="blue"><a href="/">首页</a></span> &gt; 玩法介绍 </p>
        <div id="recommend_list" class="fl font14">
        	<ul>
				<?php if(!empty($recommend)):
					foreach($recommend as $list):?>
            	<li><span><?php echo date( 'Y-m-d ',strtotime($list['created']));?></span><a href="/news/news_detaile/<?php echo $list['id'];?>/play"><?php echo $list['title'];?></a></li>
				<?php endforeach;
				endif;?>
            </ul>
        </div>
