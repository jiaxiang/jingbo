...
<title><?php echo $site_config['site_title'];?>-新闻列表</title>
...
<div id="recommend" class="fl mt5">
    	<p id="recommend_tit">您所在的位置：<span class="blue"><a href="/">首页</a></span> &gt;&gt; <a href="/news">新闻中心</a> > <?php echo $list_title;?></p>
        <div id="recommend_list" class="fl font14">
        	<ul>
				<?php if(!empty($news)):
					foreach($news as $k=>$v):
				?>
            	<li><span><?php echo date( 'Y-m-d ',strtotime($v['created']));?></span><a href="/news/news_detaile/<?php echo $v['id']?>"><?php echo tool::cut_str($v['title'],36);?></a></li>
				<?php endforeach;
				endif;?>	
            </ul>
        </div>
