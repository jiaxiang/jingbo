...
<title><?php echo $site_config['site_title'];?>-
<?php
	$lottnumtype=Kohana::config('ticket_type.type');
	$lotty_url = array('8'=>'dlt','9'=>'plw','10'=>'qxc');
?>
<?php echo $lottnumtype[$ticket_type];?>-合买大厅</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?><?php echo $lotty_url[$ticket_type];?>"><font class="blue"><?php echo $lottnumtype[$ticket_type];?></font></a> &gt; 合买大厅
	</div>
...
<div id="bd" class="clearfix m-t"> <?php echo View::factory('buycenter_menu')->render();?>
  ...
  <div id="container">
    ...
    <a href="<?php echo url::base();?><?php echo $lotty_url[$ticket_type];?>" title="" class="r" target="_blank">发起合买&gt;&gt;</a></div>
    <div class="hm-plan">
      <div class="content">
        <div class="c-wrap">
          <div class="c-inner">
