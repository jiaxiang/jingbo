...
<div class="width line36">
	...
	<span class="blue"><a href="<?php echo url::base();?>distribution/agent_client">下线用户列表</a></span> &gt;&gt; 月结合约
</div>
<!--面包屑导航_end-->
...
<!-- Content Core Start -->
		<div class="member_right fl">
			<div id="member_tit" class="fl">
				<ul>
					<li class="hover">下线用户&nbsp;<?php echo $client['lastname'];?>&nbsp;月结合约列表</li>
				</ul>
			</div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl member_box">
				...
				<tr height="33">
					<td width="15%"  align="center" valign="middle">
						<a href="<?php echo url::base().'distribution/client_month_contract/detail/'.$contract['id'];?>" target="_blank">查看</a>&nbsp;
						<?php if($contract['flag']==0) {?>
						<a href="<?php echo url::base().'distribution/client_month_contract/open/'.$contract['id'];?>">生效</a>&nbsp;
						<?php } else {?>
						<a href="<?php echo url::base().'distribution/client_month_contract/close/'.$contract['id'];?>">关闭</a>&nbsp;
						<?php } ?>
						<a href="<?php echo url::base().'distribution/client_month_contract/delete/'.$contract['id'];?>" 
...
{
	document.location.href='/distribution/client_month_contract/add/<?php echo $relation['id'];?>';
}
</script>
</html>