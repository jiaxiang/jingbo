...
<title><?php echo $site_config['site_title'];?>-会员中心-代理服务-月结报表详细</title>
...
<div class="width line36">
	...
	<span class="blue"><a href="#">代理服务</a></span> &gt;&gt; 月结报表详细
</div>
<!--面包屑导航_end-->
	...
	<div class="member_right fl">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl member_box">
			...
			<tr height="33">
				...
				<!-- 
				<td width="10%" align="center" valign="middle"><?php echo $stlDtl['mcid'];?>&nbsp;</td>
				 -->
				<td width="10%" align="center" valign="middle"><?php echo $stlDtl['lastnameMark'];?>&nbsp;</td>
