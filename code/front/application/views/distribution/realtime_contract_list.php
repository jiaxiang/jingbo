...
<title><?php echo $site_config['site_title'];?>-会员中心-代理服务-即时合约</title>
...
<div class="width line36">
	...
	<span class="blue"><a href="#">代理服务</a></span> &gt;&gt; 即时合约</div>
<!--面包屑导航_end-->
		...
		<div class="member_right fl">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl" style="border: solid 1px #c5ddf5; border-bottom:0;">
				<tr height="33">
					...
					<td width="10%" align="center" valign="middle" bgcolor="#f3f3f3">实时返点率</td>
