...
<title><?php echo $site_config['site_title'];?>-会员中心-代理服务-月度结算报表</title>
...
<div class="width line36">
	...
	<span class="blue"><a href="#">代理服务</a></span> &gt;&gt; 月度结算报表</div>
<!--面包屑导航_end-->
		...
		<div class="member_right fl">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl" style="border: solid 1px #c5ddf5; border-bottom:0;">
				<tr height="33">
					...
					<td width="10%" align="center" valign="middle" bgcolor="#f3f3f3">帐期</td>
					<td width="10%" align="center" valign="middle" bgcolor="#f3f3f3">北单</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="fl member_box">
				...
				<tr height="33">
					<td width="5%" align="center" valign="middle">
						<a href="settle_month_dtl/index/<?php echo $contract['id'];?>">查看详细</a>
					</td>
					<td width="5%" align="center" valign="middle"><?php echo $contract['mcid'];?>&nbsp;</td>
					<td width="10%" align="center" valign="middle"><?php echo $contract['spid'];?>&nbsp;</td>
					<td width="10%" align="center" valign="middle"><?php echo $contract['type'];?>&nbsp;</td>
					<td width="10%" align="center" valign="middle">￥<?php echo $contract['fromamt'];?>&nbsp;</td>
					<td width="5%" align="center" valign="middle"><?php echo $contract['rate'];?>&nbsp;</td>
					<td width="10%" align="center" valign="middle">￥<?php echo $contract['bonus'];?>&nbsp;</td>
					<td width="10%" align="center" valign="middle"><?php echo $contract['settletime'];?>&nbsp;</td>
				</tr>
				<?php };?>
			</table>
			<?php }else {?>
