...
<title><?php echo $site_config['site_title'];?>-自动跟单记录</title>
...
(
	...
	'media/auto_order/js/followhist',
), FALSE);
?>
<style>
...
<div class="buy_rec">
                	<ul class="my_tab">
                    	...
                    	<li><a href="/user_auto_order/followme" >定制我的用户</a></li>
                    	<li><a href="/user_auto_order/followhist" class="cur">自动跟单记录</a></li>
                    </UL>
<!-- 	<div class="my_title"> -->
<!--     	<h2>我定制的跟单</h2> -->
<!--     </div>                     -->                         
