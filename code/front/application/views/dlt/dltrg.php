...
<title><?php echo $site_config['site_title'];?>-超级大乐透-订单详情</title>
...
您现在的位置：<a title="网上买彩票" href="/">首页</a> &gt; 
		...
		<div id="main">
            ...
            <div class="box_m">
              <div class="det_t_bg">
               	...
               	<div class="det_h">
                    	<h2>超级大乐透 第<?php echo $qihao; ?>期   				
					
							<?php 
						$ticket_type=Kohana::config('ticket_type.method');
						echo $ticket_type[8][$wtype]?>
 					...
 					<a id="hmlist" class="m_link" href="/buycenter/lottnumpub/8/">返回合买列表&gt;&gt;</a>
                </div>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="buy_table">
                      ...
                      <tr class="last_tr">
                        ...
                        <td class="con_content">
                            ...
                            <p style="word-wrap:break-word;width:500px;overflow:hidden;">该方案对所有网友开放。</p>
                            <?php }else{?>
												...
												<p align="right"
													...
													<span lang="EN-US"
														...
														target="_blank" href="http://<?php echo $site_config['name'];?>"><span
															style="COLOR: blue; mso-bidi-font-size: 11.0pt"><?php echo $site_config['name'];?></span>
													</a>
													<br>
													</span><span
