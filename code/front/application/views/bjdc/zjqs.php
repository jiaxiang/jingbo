...
<title><?php echo $site_config['site_title'];?>-单场竞猜-总进球数</title>
...
#vs_table .sp_value{font-weight:normal;}
</style>
<?php
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>bjdc/rqspf"><font class="blue">单场竞猜</font></a> &gt; 总进球数
	</div>
...
<li class="hover"><a href="<?php echo url::base();?>bjdc/zjqs"><span>总进球数</span></a></li>
...
<li ><a href="<?php echo url::base();?>bjdc/my"><span>我的方案</span></a></li>
  ...
  <div id="jingcai_bottom" class="fl">
    <div class="dc_l"> <a href="<?php echo url::base();?>bjdc/zjqs" title="普通投注" class="on"><em>普通投注</em><s></s></a> 
    <!-- a href="zqdc_spf_ds.html" title="单式投注" ><em>单式投注</em><s></s></a--> </div>
...
<td colspan="15" class="dc_hs" style="line-height: 16px; height: 16px;">
...
<td><!-- 场次编号 -->
<input checked="checked" class="chbox" style="cursor: default;" type="checkbox"><span class="chnum"><?=$data[$i]['match_no']?></span>
</td>
...
<?php
if ($data[$i]['code'] == 0 && $data[$i]['sp_r'] != NULL) {
?>
<input class="chbox" value="0" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="0" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br />
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'1'};?></span>
<?php
	} 
?>
</label>
...
?>
<input class="chbox" value="1" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="1" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br>
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'2'};?></span>
<?php
	} 
?>
</label>
...
?>
<input class="chbox" value="2" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="2" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br>
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'3'};?></span>
<?php
	} 
?>
</label>
...
?>
<input class="chbox" value="3" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="3" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br>
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'4'};?></span>
<?php
	} 
?>
</label>
...
<label class="label_br">&nbsp;
<?php
if ($data[$i]['code'] == 4 && $data[$i]['sp_r'] != NULL) {
?>
<input class="chbox" value="4" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="4" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br>
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'5'};?></span>
<?php
	} 
?>
</label>
...
<label class="label_br">&nbsp;
<?php
if ($data[$i]['code'] == 5 && $data[$i]['sp_r'] != NULL) {
?>
<input class="chbox" value="5" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="5" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br>
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'6'};?></span>
<?php
	} 
?>
</label>
...
<label class="label_br">&nbsp;
<?php
if ($data[$i]['code'] == 6 && $data[$i]['sp_r'] != NULL) {
?>
<input class="chbox" value="6" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="6" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br>
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'7'};?></span>
<?php
	} 
?>
</label>
...
<label class="label_br">&nbsp;
<?php
if ($data[$i]['code'] == 7 && $data[$i]['sp_r'] != NULL) {
?>
<input class="chbox" value="7+" onclick="return false" type="checkbox" disabled="disabled"><br />
<span class="sp_value eng red"><?=round($data[$i]['sp_r'], 2)?></span>
<?php
	}
	else { 
?>
<input class="chbox" value="7+" onclick="return false" type="checkbox" <?php if ($data[$i]['code'] != NULL) echo 'disabled="disabled"';?>><br>
<span class="sp_value eng"><?php if ($data[$i]['sp_r'] != NULL) echo '--'; else echo $sp->{'8'};?></span>
<?php
	} 
?>
</label>
...
<input class="vs_check_all" onclick="return false" type="checkbox">
</td>
</tr>
<?php
	} 
...
?>	
			...
			<a style="left: 992px;" title="回到顶部" class="back_top" href="#top" hidefocus="true">回到顶部</a>
		</div>
...
<input id="playid" name="playid" value="40" type="hidden">
...
<div id="ft">
 <textarea id="responseJson" style="display: none;">{
	period :      "110706",   //期号
	serverTime :  "2011-07-12 10:12:41",   //服务器时间
...
<div style="position: absolute; display: none; z-index: 9999;" id="livemargins_control"><img src="zqdc_zjqs_files/monitor-background-horizontal.png" style="position: absolute; left: -77px; top: -5px;" height="5" width="77"> <img src="zqdc_zjqs_files/monitor-background-vertical.png" style="position: absolute; left: 0pt; top: -5px;"> <img id="monitor-play-button" src="zqdc_zjqs_files/monitor-play-button.png" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0.5" style="position: absolute; left: 1px; top: 0pt; opacity: 0.5; cursor: pointer;"></div>
