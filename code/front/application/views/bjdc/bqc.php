...
<title><?php echo $site_config['site_title'];?>-单场竞猜-半全场</title>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>bjdc/rqspf"><font class="blue">单场竞猜</font></a> &gt; 半全场
	</div>
...
<li class="hover"><a href="<?php echo url::base();?>bjdc/bqc"><span>半全场</span></a></li>
<li ><a href="<?php echo url::base();?>bjdc/my"><span>我的方案</span></a></li>
  ...
  <div id="jingcai_bottom" class="fl">
    <div class="dc_l"> <a href="<?php echo url::base();?>bjdc/bqc" title="普通投注" class="on" ><em>普通投注</em><s></s></a> 
...
<td colspan="16" class="dc_hs" style="line-height: 16px; height: 16px; ">
...
&nbsp;<input class="chbox" value="胜-胜" onclick="return false" type="checkbox" /><br />
<span class="sp_value eng"><?=$sp->{'1'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="胜-平" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'2'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="胜-负" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'3'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="平-胜" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'4'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="平-平" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'5'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="平-负" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'6'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="负-胜" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'7'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="负-平" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'8'}?></span>
</label>
</td>
<td class="h_br">
<label class="label_br">
&nbsp;<input class="chbox" value="负-负" onclick="return false" type="checkbox"><br>
<span class="sp_value eng"><?=$sp->{'9'}?></span>
</label>
</td>
	...
	<div class="box_m">
		...
		<div class="dc_r_m">
			...
			<p class="dc_qr">
				...
				奖金预测：<span style="display:none" id="jiangjinYS" class="red">0-0</span> <!-- a href="javascript:void(0)" id="see_prize_predict">查看明细</a--><a id="see_prize_predict" href="javascript:void(0)">查看明细</a>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" id="clear_all">清空所选</a>
			</p>
...
<input id="playid" name="playid" value="51" type="hidden">
...
<textarea id="responseJson" style="display: none;">{
	period :      "110707",   //期号
	serverTime :  "2011-07-12 18:14:53",   //服务器时间
...
<img src="zqdc_bqc_files/monitor-background-horizontal.png" style="position: absolute; left: -77px; top: -5px;" height="5" width="77">	
<img src="zqdc_bqc_files/monitor-background-vertical.png" style="position: absolute; left: 0pt; top: -5px;">	<img id="monitor-play-button" src="zqdc_bqc_files/monitor-play-button.png" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0.5" style="position: absolute; left: 1px; top: 0pt; opacity: 0.5; cursor: pointer;"></div>
<div class="tips_m" style="top: 700px; width: 500px; display: none; position: absolute;" id="yclass_alert">	<div class="tips_b">        
<div class="tips_box">           
<div style="cursor: move;" class="tips_title">               
...
<div style="position: absolute; left: 0pt; top: 0pt; display: none; z-index: 9; width: 88%; height: 30px; background: none repeat scroll 0% 0% rgb(238, 238, 238); opacity: 0.1; cursor: move;">
</div></div>
<div class="notifyicon tip-2"><div class="notifyicon_content"></div>
<div class="notifyicon_arrow"><s></s><em></em></div>
<div class="notifyicon_space"></div></div>
</body>
</html>