...
<title><?php echo $site_config['site_title'];?>-竞彩足球-购买交易区</title>
...
(   'media/js/yclass.js?v=20110509',
    'media/js/loginer',
	'media/js/detail',
	'media/js/jczq_v_buy.js?v=20120220',
), FALSE);
...
<form method='post' action="<?php echo url::base();?>jczq_v/pute" id="buyform">
