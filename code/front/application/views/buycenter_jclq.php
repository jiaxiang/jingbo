...
<title><?php echo $site_config['site_title'];?>-竞彩篮球-合买大厅</title>
...
var submit_url="jclq/viewdetail_join/";
var submit_url_join="jclq/submit_buy_join";
...
<body>
<iframe style="position: fixed; display: none; opacity: 0;" frameborder="0" onload="javascript:dyniframesize('ifm');" ></iframe>
...
<div class="width line36 gray68">
	<div style="float:left; margin-left:20px;">
		...
		<a href="<?php echo url::base();?>jclq/rfsf"><font class="blue">竞彩篮球</font></a> &gt; 合买大厅
	</div>
...
<div id="bd" class="clearfix m-t"> <?php echo View::factory('buycenter_menu')->render();?>
  <div id="container">
    <div class="hmzx-top"><span class="l"><strong>竞彩篮球合买方案</strong><span>&nbsp;&nbsp;<span id="endtimelist">截止时间：赛前20分钟</span></span></span><a href="/jclq/sf/" title="" class="r" target="_blank">发起合买&gt;&gt;</a></div>
    <div class="hm-plan">
      <div class="content">
        <div class="c-wrap">
          <div class="c-inner">
            <div class="an_title p-l0">
              ...
              <em class="an_top" style="_padding-top:5px;"></em>
               </div>
            <div class="c-search"> <span class="l">
              ...
              <select name="playid_term" id="playid_term" class="m-r" onchange="do_search(2,'')">
                    <option selected="selected" value="0">过关方式</option>
                    <option value="单关">单关</option>
                    <option value="2串1">2串1</option>
                    <option value="3串1">3串1</option>
                    <option value="4串1">4串1</option>
                    <option value="5串1">5串1</option>
                    <option value="6串1">6串1</option>
              </select>
