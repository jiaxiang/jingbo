...
<title><?php echo $site_config['site_title'];?>-排列三-订单详情</title>
		...
		<div id="main">
            ...
            <div class="box_m">
              <div class="det_t_bg">
					...
					<div id="lot-logo" class="s-logo pls-logo"></div>
               	<div class="det_h">
                    	<h2>排列三 第<?php echo $qihao; ?>期   
						<?php 
						$plstype=Kohana::config('ticket_type.method');
						echo $plstype[11][$wtype]?>
                  ...
                  <a id="hmlist" class="m_link" href="/buycenter/lottnumpub/11/">返回合买列表&gt;&gt;</a>
                </div>
