...
class Qxc_Controller extends Template_Controller {
	...
	public function index(){
		...
		$this->template = new View('qxc/index',$data);
	...
	public function yb(){
		...
		$this->template = new View('qxc/qxc_yb',$data);
		$this->template->render(TRUE);
	}
	...
	public function view($pid){
        ...
        try 
        {
        	...
        	$this->template = new View('qxc/qxcrg', $data);
	...
	public function succ($pid){
        ...
        try{
			...
			$this->template = new View('qxc/success', $data);
	        $this->template->set_global('_user', $this->_user);
        }
	 	catch(MyRuntimeException $ex)
        {
