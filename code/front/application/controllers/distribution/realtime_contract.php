...
//		$this->template->content->user = $this->_user;
        ...
        $view = new View('distribution/realtime_contract_list', $data);
		$view->set('dataList', $contractList);
		$view->set_global('_user', $this->_user);
		$view->set_global('_nav', 'realtime_contract');
		$view->render(TRUE);
	}
