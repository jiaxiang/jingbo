...
class Plw_Controller extends Template_Controller {
	...
	public function  index(){
		...
		$this->template = new View("guoguan/plw",$data);
	...
	public function current(){
		...
		echo '<?xml version="1.0" encoding="UTF-8"?>
				<rows gid="52" pid="'.$expect.'"  code="'.$data_e['awardnum'].'"   gsale="'.$jiangjin['0'].'"   ginfo="'.$ginfo.'" ninfo="'.$ninfo.'" gpool="'.$jiangjin['1'].'" etime="" atime="'.$data['ktime'].'">
<as total="31" ps="25" tp="2"/>
<af total="0" ps="25" tp="0"/>
<ds total="0" ps="25" tp="0"/>
<fs total="31" ps="25" tp="2"/>
