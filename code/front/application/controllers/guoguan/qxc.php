...
class Qxc_Controller extends Template_Controller {
	...
	public function  index(){
		...
		$this->template = new View("guoguan/qxc",$data);
	...
	public function current(){
		...
		echo '<?xml version="1.0" encoding="UTF-8"?>
				<rows gid="51" pid="'.$expect.'"  code="'.$data_e['awardnum'].'"   gsale="'.$jiangjin['0'].'"  ginfo="'.$ginfo.'" ninfo="'.$ninfo.'" gpool="'.$jiangjin['1'].'" etime="" atime="'.$data['ktime'].'" >
