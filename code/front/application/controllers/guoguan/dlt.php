...
class Dlt_Controller extends Template_Controller {
	...
	public function  index(){
		...
		$this->template = new View("guoguan/dlt",$data);
	...
	public function current(){
		...
		echo '<?xml version="1.0" encoding="UTF-8"?>
				<rows gid="50" pid="'.$data['qihao'].'" code="'.$data_e['awardnum'].'" gsale="'.$jiangjin['0'].'" ginfo="'.$ginfo.'" ninfo="'.$ninfo.'" gpool="'.$jiangjin['1'].'" etime="" atime="'.$data['ktime'].'" >
				<as total="0" ps="0" tp="0" />
			</rows>';
	}
