...
class Plw_Controller extends Template_Controller {
	...
	public function index(){
		...
		$this->template = new View('plw/index',$data);
	...
	public function yb(){
		...
		$this->template = new View('plw/plw_yb',$data);
		$this->template->render(TRUE);
	}
	...
	public function view($pid){
        ...
        try 
        {
        	...
        	$this->template = new View('plw/plwrg', $data);
	...
	public function succ($pid){
        ...
        try{
			...
			$this->template = new View('plw/success', $data);
	        $this->template->set_global('_user', $this->_user);
        }
	 	catch(MyRuntimeException $ex)
        {
    ...
    {
    	//当前期
    	$isnowexpect = Qihaoservice::get_instance()->getisnow(9);
    	if(!$isnowexpect) {
    		$new_expect = 10000000;
    	}else{
