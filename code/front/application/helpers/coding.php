...
class coding_Core {
	...
	public static function decode_product($product)
	{
		...
		if (!empty($product['goods_attributeoption_relation_struct_default'])) {
			if (is_string($product['goods_attributeoption_relation_struct_default'])) {
	...
	{
		if (!empty($good['goods_attributeoption_relation_struct'])) {
			if (is_array($good['goods_attributeoption_relation_struct'])) {
				$good['goods_attributeoption_relation_struct'] = json_encode($good['goods_attributeoption_relation_struct']);
			}
		} elseif (isset($good['goods_attributeoption_relation_struct'])) {
			$good['goods_attributeoption_relation_struct'] = '';
		}
	...
	{
		if (!empty($good['goods_attributeoption_relation_struct'])) {
			if (is_string($good['goods_attributeoption_relation_struct'])) {
				$good['goods_attributeoption_relation_struct'] = json_decode($good['goods_attributeoption_relation_struct'], TRUE);
			}
		} elseif (isset($good['goods_attributeoption_relation_struct'])) {
    ...
    public static function decode_attributeoption($attributeoption)
    {
    	...
    	} else{//if (isset($attributeoption['meta_struct'])) {
     ...
     * @return array
     */
    public static function decode_attribute($attribute)
    {
    	if (!empty($attribute['meta_struct'])) {
    		if (is_string($attribute['meta_struct'])) {
    			$attribute['meta_struct'] = json_decode($attribute['meta_struct'], TRUE);
    		}
    	} else{//if (isset($attribute['meta_struct'])) {
    		$attribute['meta_struct'] = array();
    	}
