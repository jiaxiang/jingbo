...
// [CH] 以下变量请根据空间商提供的账号参数修改,如有疑问,请联系服务器提供商
	...
	$dbhost = '192.168.1.102';			// 数据库服务器
	$dbuser = 'jingbo365';			// 数据库用户名
	$dbpw = 'ZWP7RPRdMN9VqCzW';				// 数据库密码
	$dbname = 'jingbo365';			// 数据库名
...
define('UC_DBHOST', '192.168.1.102');
define('UC_DBUSER', 'jingbo365');
define('UC_DBPW', 'ZWP7RPRdMN9VqCzW');
define('UC_DBNAME', 'jingbo365');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`jingbo365`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'S71fZ8k3l1La97Vd96r8P2XaV745X0Ybzbg4e0h5k0keL1maq821eaubJ8E3CeO6');
define('UC_API', 'http://jingbo365.surbiz.com/ucenter');
