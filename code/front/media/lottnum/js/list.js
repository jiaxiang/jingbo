            ...
            case 2:
                ...
                if(type==2){
                	if(point){
                		...
                		if(point==2){
                			Y.get('#playid_term').one().options[0]= new Option('直选单式',3);
							Y.get('#playid_term').one().options[1]= new Option('组六单式',6);
							Y.get('#playid_term').one().options[2]= new Option('组三单式',10);
                			...
                			Y.get('#playid_term').one().options[0]= new Option('直选复式',1);
							Y.get('#playid_term').one().options[1]= new Option('组六复式',5);
							Y.get('#playid_term').one().options[2]= new Option('组三复式',9);
							Y.get('#playid_term').one().options[3]= new Option('直选和值',4);
