...
//获取期号
var issue_url = "/lotteryapi/sdata/lotissue?lottid=9";
var fq_url = "/lotteryapi/orderprocess/ordersub?lottid=9";
//开奖公告
var kjgg_url = "/lotteryapi/sdata/lotnotice?lottid=9";
//号码对象
    ...
    Class({
        ...
        index:function (){
           ...
           /* this.lib.PLHotCoolChart({
                xml: '/static/info/plw/omit/wzyl_100.xml'
            });*/
            /*this.getTiDian({//提点与专家
                kj: '/static/info/kaijiang/xml/plw/index.xml',
                kj5: '/static/info/kaijiang/xml/plw/list5.xml',
           ...
           this.get('#buy_dg,#buy_hm,#buy_zh').click(function (e, y){
               var data, msg;
				...
				y.postMsg('msg_login', function (){
				   ...
				   if(Class.config('play_name') == 'dq' && y.postMsg('msg_dq_check_err').data){
                       return false//多期额外检测
                   }
				   if(Class.config('play_name') == 'dq' && y.postMsg('msg_dq_check_err').data){
                       return false//多期额外检测
