...
ESONCalendar={
    ...
    addStyle:function(){
        ...
        cssText+="#ESONCalendar_caption{padding:3px;background:#C0D0E8;width:184px;height:20px;}";
        cssText+=".esonclear{clear:both}";
        cssText+="#selMonth{margin-right:5px;width:80px}";
        cssText+="#ESONCalendar_table{background:#F6F6F6;border-collapse:collapse;border:1px solid #C0D0E8}";
        cssText+="#ESONCalendar_table th{border:1px #C0D0E8 solid}";
        cssText+="#ESONCalendar_week{background:#C0D0E8}";
        ...
        cssText+="#ESONCalendar_foot{line-height:30px;text-align:center;font-size:12px;color:#003366;background:#C0D0E8}";
